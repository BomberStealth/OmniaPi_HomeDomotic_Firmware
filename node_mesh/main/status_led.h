/**
 * OmniaPi Node Mesh - Status LED Driver
 *
...
typedef enum {
    ...
    STATUS_LED_SEARCHING,    // Slow blink - searching for mesh network
    STATUS_LED_CONNECTED,    // Solid on - connected to mesh
    STATUS_LED_ERROR,        // Very fast blink - error state
    STATUS_LED_OTA,          // Double blink - OTA in progress
    STATUS_LED_COMMISSIONING,// Triple blink - commissioning mode
